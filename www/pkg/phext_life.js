...
export class PhextLife {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        PhextLifeFinalization.unregister(this);
        return ptr;
    }
    free() {
     ...
     */
    population() {
        const ret = wasm.phextlife_population(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./phext_life_bg.js": import0,
    };
}

const PhextLifeFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_phextlife_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('phext_life_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
